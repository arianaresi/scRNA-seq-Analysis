...
De la misma manera, se recomienda encarecidamente leer la información general del código en el siguiente [apartado](https://github.com/arianaresi/scRNA-seq-Analysis/tree/main/Descripción/InformacionGeneral).
