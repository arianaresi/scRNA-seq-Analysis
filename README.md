...
Para una mayor comprensión (y una manera divertida de aprender), también adjuntamos una infografía sobre análisis bioinformático de sc-RNA seq. Haz click [aquí](https://github.com/arianaresi/scRNA-seq-Analysis/tree/main/Infografía) para aprender más con Bibble.
